...
- 代码审查用 `dual-code-review` skill（三场景路由：场景1 单路 Atlas/Sentry 日常小改动 → 场景2 主审+复审 → 场景3 双路并行+Solomon 仲裁大功能/合并main，按改动规模与风险选性价比）；细节规范见 `aiDoc/relations/development-workflow.md` 的「代码审查」章节
