<template>
  <div class="task-center">
    ...
    <el-row :gutter="12" class="mt-3">
      ...
      <el-col :span="6"><el-card shadow="hover"><div class="stat"><span>完成率</span><b class="text-success">{{ (stats.doneRate || 0).toFixed(1) }}%</b></div></el-card></el-col>
      <el-col :span="6"><el-card shadow="hover"><div class="stat"><span>逾期数</span><b class="text-error">{{ stats.overdueCount }}</b></div></el-card></el-col>
      <el-col :span="6"><el-card shadow="hover"><div class="stat"><span>进行中</span><b class="text-primary">{{ stats.doingCount }}</b></div></el-card></el-col>
    </el-row>
